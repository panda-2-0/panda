...
const NoticeModify = () => {
    ...
    datalist.append('wid', modifydata.modify);
    ...
    useEffect(() => {
        axios.post("/notice/getData" , datalist , {
            headers: {
            ...
            .then((response) => {
                ...
                // 데이터가 도착했을 때 상태 값 설정
                setTitle(response.data.writing_name);
                setCategory(response.data.category);
                setDetail_category(response.data.detail_category);
                setCount(response.data.count);
                setPrice(response.data.price);
                setContent(response.data.content);
                setWriting_photo(response.data.writingImg);
        ...
        axios.get('/check')
            .then((response)=>{
                ...
                if(response.data){
                    ...
                    axios.post(`/notice/noticeChange/${modifydata.modify}`, writing, {
                        headers: {
