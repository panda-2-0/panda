    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        .requestMatchers("ws://localhost:8080/chat","/api/searchResult","/api/todayAds", "/login", "/check","/pages/SearchResult**", "/", "/pages/loginPage", "/pages/joinMemPage", "/sign/joinMem", "/sign/**", "/login/**", "/api/isAuction").permitAll()
